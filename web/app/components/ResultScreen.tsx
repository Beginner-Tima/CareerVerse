          ...
          >
            ...
            {m.labourMarket && (
              <dl className="mt-4 grid grid-cols-2 gap-3 border-t border-white/5 pt-4 text-sm sm:grid-cols-3">
                ...
                {/* Пустые ячейки не показываем: у профессий из широкого каталога
                    источник даёт долю вакансий и годовую динамику, но не их
                    число, и прочерк рядом с заполненным соседом читается как
